    ...
    conv_handler = ConversationHandler(
        ...
        states={
            MAINMENU: [
                ...
                CallbackQueryHandler(pattern="^gpt_tictactoe$", callback=tictactoe_gpt_start),
            ],
            ...
            TICTACTOE_ONLINE: [CallbackQueryHandler(callback=tictactoe_online, pattern="^[0-8]$"), 
                        CallbackQueryHandler(pattern='menu', callback=start)],
            TICTACTOE_GPT: [CallbackQueryHandler(callback=tictactoe_gpt, pattern="^[0-8]$"), 
                        CallbackQueryHandler(pattern='menu', callback=start)],
        },
